const PrivacyPolicy = () => {
  return (
    <div className="flex flex-col gap-y-4 p-4 text-md">
      ...
      <div>
        ...
        <p>
          Contact Information: If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at contact@indigomilestones.com
        </p>
      </div>
